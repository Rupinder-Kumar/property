 ...
 useEffect(() => {
        async function fetchPropertyData() {
            try {
                ...
                const response = await fetch(`http://localhost:4300/propertyData/${property_id}`);
                ...
                setFormData({
                    ...
                    furnishingStatus: property_data.furnishingOptions || [],
...
const handleDateChange = (e) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
	  if (!formData.propertyType || !formData.propertylocation || !formData.propertyName || !formData.propertyLocality || !formData.saleableArea || !formData.propertyPrice || !formData.propertyStatus || !formData.possessionDate || !formData.transactionType || !formData.description || !file) {
  ...
  <div className="checkbox-group">
    <div className="checkbox-item">
      <input
		...
		checked={formData.furnishingStatus.includes('furnishing_icon_sofa')}
        id="Sofa"
      />{" "}
    ...
    <div className="checkbox-item">
      <input
        ...
        id="Refrigerator"
		checked={formData.furnishingStatus.includes('furnishing_icon_fridge')}
      />{" "}
    ...
    <div className="checkbox-item">
      <input
        ...
        id="Dining_Table"
		checked={formData.furnishingStatus.includes('furnishing_icon_dining')}
      />{" "}
    ...
    <div className="checkbox-item">
      <input
        ...
        id="Gas_Connection"
		checked={formData.furnishingStatus.includes('furnishing_icon_gas')}
      />{" "}
